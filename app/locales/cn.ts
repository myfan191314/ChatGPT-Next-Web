...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "我是人工智能chatGPT，哦，对不起，我好像没有您的访问许可，请您联系我的管理员（杨老师微信baby1504a）以便我能为您提供优质的AI服务，或者您也可以添加我的另一个双胞胎哥哥，（微信：myfan8866191314），他科比我脑子灵光多了，再或者请前往[登录](/#/auth)页输入正确的访问密码^_^。",
  },
  Auth: {
    Title: "需要密码",
  ...
  Store: {
    DefaultTopic: "新的对话",
    BotHello: "你好，我是心途AI，一个基于世界上最先进的chatGPT人工智能大脑，您可以问我你想知道的问题，或者我已经知道的问题，但是请不要涉及关于其他敏感问题（政治、色情等违规问题）我可能无法回答您，也可以联系我们客服人员（杨老师13439114167，王老师15313193176)我们会尽力为您解答，请问有什么可以帮你的吗？",
    Error: "出错了，稍后重试吧",
    Prompt: {
