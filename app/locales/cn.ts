...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ...
      : "我是世界上最优秀的人工智能模型chatGPT，真是对不起，我这里没有您的访问许可，请您联系我的管理员（杨老师微信baby1504a）为您开通访问许可，以便我为您提供更优质的AI服务，或者您也可以添加我的另一个双胞胎哥哥（微信：wxid_tjpp6zfraycv22），获取更多关于《遇见.心途》的的信息。再或者您也可以请前往[登录](/#/auth)页输入正确的访问许可^_^。",
  },
  Auth: {
    Title: "需要密码",
